...
urlpatterns = [
    ...
    # Workout Library - Use str for UUID instead of int
    ...
    path('meals/<int:meal_id>/', views.admin_meal_detail, name='admin_meal_detail'),
    path('meals/<int:meal_id>/edit/', views.admin_meal_edit, name='admin_meal_edit'),
    ...
    path('api/meals/<int:meal_id>/delete/', views.api_meal_delete, name='api_meal_delete'),
