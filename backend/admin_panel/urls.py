...
urlpatterns = [
    ...
    path('workout-library/<str:workout_id>/view/', views.admin_workout_library_view, name='admin_workout_library_view'),
    # ========== NEW: Exercise Library Routes ==========
    path('exercise-library/', views.admin_exercise_library, name='admin_exercise_library'),
    path('exercise-library/create/', views.admin_exercise_create, name='admin_exercise_create'),
    path('exercise-library/<str:exercise_id>/edit/', views.admin_exercise_edit, name='admin_exercise_edit'),
    ...
    # ========== NEW: API Endpoints - Exercise Library ==========
    path('api/exercises/list/', views.api_exercises_list, name='api_exercises_list'),
    path('api/exercises/<str:exercise_id>/detail/', views.api_exercise_detail, name='api_exercise_detail'),
    path('api/exercises/<str:exercise_id>/delete/', views.api_exercise_delete, name='api_exercise_delete'),
    
    # ========== API Endpoints - Meals ==========
    path('api/meals/list/', views.api_meals_list, name='api_meals_list'),
    path('api/meals/<str:meal_id>/delete/', views.api_meal_delete, name='api_meal_delete'),
