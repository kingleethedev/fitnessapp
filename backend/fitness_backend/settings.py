...
INSTALLED_APPS = [
    ...
    'cloudinary_storage', 
    'firebase_admin', # Add Cloudinary storage
...
if FIREBASE_CREDENTIALS_JSON:
    ...
    print("⚠️ No Firebase credentials found. Google Sign-In will not work.")
    FIREBASE_CREDENTIALS = None
...
if CLOUDINARY_STORAGE['CLOUD_NAME']:
    ...
    # For videos - create a custom storage class
    # We'll define this in a separate file
    MEDIA_URL = '/media/'
    
    # Add Cloudinary to INSTALLED_APPS if not already there
    # INSTALLED_APPS should include 'cloudinary_storage' and 'cloudinary'
