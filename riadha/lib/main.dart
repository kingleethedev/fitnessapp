  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        home: const SplashScreen(), // Direct widget, not a route
        routes: {
          '/login': (context) => const LoginScreen(),
          '/register': (context) => const RegisterScreen(),
          '/onboarding': (context) => const OnboardingScreen(),
          '/home': (context) => const HomeScreen(),
          '/workout-preview': (context) => const WorkoutPreviewScreen(),
          '/workout-execution': (context) => const WorkoutExecutionScreen(),
          '/workout-complete': (context) => const WorkoutCompleteScreen(),
